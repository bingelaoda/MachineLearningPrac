...
/*   5:    */ 
/*   6:    */ public class KDConditionalEstimator
/*   7:    */   implements ConditionalEstimator
/*   8:    */ {
/*   9:    */   private KernelEstimator[] m_Estimators;
/*  10:    */   
/*  11:    */   public KDConditionalEstimator(int numCondSymbols, double precision)
/*  12:    */   {
/*  13: 49 */     this.m_Estimators = new KernelEstimator[numCondSymbols];
/*  14: 50 */     for (int i = 0; i < numCondSymbols; i++) {
/*  15: 51 */       this.m_Estimators[i] = new KernelEstimator(precision);
/*  16:    */     }
/*  17:    */   }
/*  18:    */   
...
/*  35:    */   {
/*  36: 93 */     String result = "KD Conditional Estimator. " + this.m_Estimators.length + " sub-estimators:\n";
...
/*  70:    */         }
/*  71:    */       }
/*  72:137 */       KDConditionalEstimator newEst = new KDConditionalEstimator(maxB + 1, 1.0D);
/*  73:139 */       for (int i = 0; i < argv.length - 1; i += 2)
/*  74:    */       {
/*  75:140 */         currentA = Integer.parseInt(argv[i]);
/*  76:141 */         currentB = Integer.parseInt(argv[(i + 1)]);
/*  77:142 */         System.out.println(newEst);
/*  78:143 */         System.out.println("Prediction for " + currentA + '|' + currentB + " = " + newEst.getProbability(currentA, currentB));
/*  79:    */         
/*  80:    */ 
/*  81:146 */         newEst.addValue(currentA, currentB, 1.0D);
/*  82:    */       }
/*  83:    */     }
/*  84:    */     catch (Exception e)
/*  85:    */     {
/*  86:149 */       System.out.println(e.getMessage());
/*  87:    */     }
/*  88:    */   }
/*  89:    */ }
 ...
 * Qualified Name:     weka.estimators.KDConditionalEstimator
