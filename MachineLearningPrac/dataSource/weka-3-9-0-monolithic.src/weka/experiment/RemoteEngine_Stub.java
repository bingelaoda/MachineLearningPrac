  ...
  implements Compute, Remote
{
    ...
    throws Exception
  {
    if (useNewInvoke)
    {
      localObject1 = this.ref.invoke(this, $method_checkStatus_0, new Object[] { paramObject }, 8527603492100504454L);
      return localObject1;
    }
    Object localObject1 = this.ref.newCall(this, operations, 0, -8065814382466137525L);
    try
    {
    ...
    throws RemoteException
  {
    try
    {
      if (useNewInvoke)
      {
        localObject1 = this.ref.invoke(this, $method_executeTask_1, new Object[] { paramTask }, 3272821424511182813L);
        return localObject1;
      }
      Object localObject1 = this.ref.newCall(this, operations, 1, -8065814382466137525L);
      try
      {
        ObjectOutput localObjectOutput = ((RemoteCall)localObject1).getOutputStream();
 ...
 * Qualified Name:     weka.experiment.RemoteEngine_Stub
