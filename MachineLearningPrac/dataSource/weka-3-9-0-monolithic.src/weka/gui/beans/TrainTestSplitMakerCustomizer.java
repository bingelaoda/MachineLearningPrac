...
/* 11:   */ 
/* 12:   */ public class TrainTestSplitMakerCustomizer
/* 13:   */   extends JPanel
/* 14:   */   implements Customizer
/* 15:   */ {
/* 16:   */   private static final long serialVersionUID = -1684662340241807260L;
/* 17:46 */   private PropertyChangeSupport m_pcSupport = new PropertyChangeSupport(this);
/* 18:49 */   private PropertySheetPanel m_splitEditor = new PropertySheetPanel();
/* 19:   */   
/* 20:   */   public TrainTestSplitMakerCustomizer()
/* 21:   */   {
/* 22:53 */     setBorder(BorderFactory.createEmptyBorder(0, 5, 5, 5));
/* 23:   */     
/* 24:55 */     setLayout(new BorderLayout());
/* 25:56 */     add(this.m_splitEditor, "Center");
/* 26:57 */     add(new JLabel("TrainTestSplitMakerCustomizer"), "North");
/* 27:   */   }
/* 28:   */   
/* 29:   */   public void setObject(Object object)
/* 30:   */   {
/* 31:67 */     this.m_splitEditor.setTarget((TrainTestSplitMaker)object);
/* 32:   */   }
/* 33:   */   
 ...
 * Qualified Name:     weka.gui.beans.TrainTestSplitMakerCustomizer
