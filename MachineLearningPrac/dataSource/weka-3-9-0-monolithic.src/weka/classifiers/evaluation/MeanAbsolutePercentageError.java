...
/*   7:    */ 
/*   8:    */ public class MeanAbsolutePercentageError
/*   9:    */   extends AbstractEvaluationMetric
/*  10:    */   implements StandardEvaluationMetric
/*  11:    */ {
/*  12: 39 */   protected double m_SumAbsolutePercentageError = 0.0D;
/*  13:    */   
...
/*  30:    */   {
/*  31: 69 */     return "The mean absolute percentage error.";
/*  32:    */   }
/*  33:    */   
...
/*  42: 90 */       this.m_SumAbsolutePercentageError += instance.weight() * Math.abs(relativeError);
/*  43:    */     }
/*  44:    */   }
/*  45:    */   
...
/*  55:    */   {
/*  56:113 */     return "Mean absolute percentage error     " + Utils.doubleToString(getStatistic("mape"), 12, 4) + "\n";
/*  57:    */   }
/*  58:    */   
/*  59:    */   public double getStatistic(String name)
/*  60:    */   {
/*  61:123 */     if (!name.equals("mape")) {
/*  62:124 */       throw new AbstractEvaluationMetric.UnknownStatisticException(this, "Statistic " + name + " is unknown.");
/*  63:    */     }
/*  64:127 */     return this.m_SumAbsolutePercentageError / (this.m_baseEvaluation.m_WithClass - this.m_baseEvaluation.m_Unclassified);
/*  65:    */   }
/*  66:    */   
 ...
 * Qualified Name:     weka.classifiers.evaluation.MeanAbsolutePercentageError
