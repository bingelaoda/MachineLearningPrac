...
/*  9:   */ 
/* 10:   */ public class MatchAllRegexValidator
...
/* 27:66 */       if (pattern.matcher(string).find()) {
/* 28:67 */         validCount++;
/* 29:   */       }
/* 30:   */     }
/* 31:71 */     if (validCount != this.matches.length)
/* 32:   */     {
 ...
 * Qualified Name:     org.boon.validation.validators.MatchAllRegexValidator
