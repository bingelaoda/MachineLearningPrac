...
/*  17: 52 */     LAPACK.getInstance().dgerqf(m, n, new double[0], Matrices.ld(m), new double[0], this.work, -1, info);
/*  18:    */     int lwork;
/*  19: 55 */     if (info.val != 0) {
/*  20: 56 */       lwork = m;
/*  21:    */     } else {
...
/*  32: 67 */     LAPACK.getInstance().dorgrq(m, n, m, new double[0], Matrices.ld(m), new double[0], this.workGen, -1, info);
/*  33: 70 */     if (info.val != 0) {
/*  34: 71 */       lwork = m;
/*  35:    */     } else {
...
/*  40:    */   }
/*  41:    */   
/*  42:    */   public static RQ factorize(Matrix A)
/*  43:    */   {
/*  44: 88 */     return new RQ(A.numRows(), A.numColumns()).factor(new DenseMatrix(A));
/*  45:    */   }
/*  46:    */   
/*  47:    */   public RQ factor(DenseMatrix A)
/*  48:    */   {
...
/*  59:106 */     LAPACK.getInstance().dgerqf(this.m, this.n, A.getData(), Matrices.ld(this.m), this.tau, this.work, this.work.length, info);
/*  60:109 */     if (info.val < 0) {
/*  61:110 */       throw new IllegalArgumentException();
/*  62:    */     }
/*  63:112 */     this.R.zero();
/*  64:113 */     for (MatrixEntry e : A) {
/*  65:114 */       if (e.column() >= this.n - this.m + e.row()) {
/*  66:115 */         this.R.set(e.row(), e.column() - (this.n - this.m), e.get());
/*  67:    */       }
/*  68:    */     }
/*  69:120 */     info.val = 0;
/*  70:121 */     LAPACK.getInstance().dorgrq(this.m, this.n, this.k, A.getData(), Matrices.ld(this.m), this.tau, this.workGen, this.workGen.length, info);
 ...
 * Qualified Name:     no.uib.cipr.matrix.RQ
